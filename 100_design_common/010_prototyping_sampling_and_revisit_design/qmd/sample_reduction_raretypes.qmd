...
- for types with sample size 0 or 1 in included domains, increase to sample size 2 (as done at stratum level for Flanders, before)
...
- increase zero-or-one-sized types to two units in included domains
