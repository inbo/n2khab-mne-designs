...
load_fitdata <- function(
  ...
  return(arrow::readRDS(data_file))
}
...
TODO uncertainty (bootstrapping)


:::{.callout-warning}
For practical simplicity, a re-use threshold of $10 m$ seems appropriate,
given that the measurement sites in question differ by less than $10 cm$ in elevation.
:::


This distance is conform with the common sense criterion (communication to land owners, cost saving).
Re-use would usually stay in the target GRTS raster cell.
