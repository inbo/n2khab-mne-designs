...
11 Ruimtebeslag:aanpassing fysische structuur
Bodemcompactie
Grondverzet
...
7.1 Verzoeting via het grondwater
...
101 Klimaatverandering  in droge perioden
...
Achter het systeemschema schuilt een kleine MS Access applicatie: de databank wordt gebruikt om de gegevens te stockeren maar biedt ook formulieren om de data op een gebruikersvriendelijke manier te raadplegen en te wijzigen.

## Structuur van de databank (in een notendop)

De figuur \@ref(fig:Systeemschema_db_structuur_simpl_col) hieronder geeft een vereenvoudigd overzicht van de structuur van de databank:
...
- Twee tabellen (in het groen) geven een overzicht van de **experten** die gespecialiseerd zijn in enerzijds bepaalde **vegetatietypen** (*tbl_Expert_Vegetatie*) en anderzijds bepaalde **milieudrukken/milieucompartimenten** (*tbl_Expert_CompartimentSS_Effectgroep*).

- De tabel *tbl_Vegetatie_Waterhuishouding_Compartiment* geeft voor elke (vegetatie)type aan welke milieucompartimenten relevant zijn (bv. habitat-sub-typen die in valleien voorkomen worden gelinkt met het milieucompartiment 'Inundatiewater' binnen de waterhuishoudingsklasse 'Tijdelijk tot permanent nat', in tegenstelling tot habitat-sub-typen van de droge milieus).

- De tabel *tbl_Pnabijheid* definieert voor elke milieudruk de positie van elk milieucompartiment in de milieuverstoringsketen (zie XXX) onder de vorm van een code gaande van 1 (aan de bron van de milieudruk) tot 3 (verder in de verstoringsketen), en waarbij 0 voor de milieucompartimenten staat die niet beïnvloed worden door een bepaalde druk (niet van toepassing).

- De tabel *tbl_Effectgroep_Standplaatsfactor* (in het rood) beschrijft de **relatie tussen milieudrukken en standplaatsfactoren**: hoe evolueert de waarde van de standplaatsfactor bij een toenemende milieudruk? Via welke actiemechanisme(n)? Hoe goed is de relatie tussen standplaatsfactor en effectgroep gedocumenteerd? Bestaan er referenties uit de literatuur of datasets die deze relatie onderbouwen?
...
# Bijlage X - Structuur van de MS Access databank van het systeemschema van de standplaats
