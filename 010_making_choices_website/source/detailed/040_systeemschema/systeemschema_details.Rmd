...
- Twee tabellen (in het groen) geven een overzicht van de **experten** die gespecialiseerd zijn in enerzijds bepaalde **types** (*tbl_Expert_Vegetatie*) en anderzijds bepaalde **milieudrukken/milieucompartimenten** (*tbl_Expert_CompartimentSS_Effectgroep*).
