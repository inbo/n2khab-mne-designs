...
outputdir <- "../../../docs/site/files/040_systeemschema"
dir.create(outputdir, recursive = TRUE)
outputdir2 <- "../../../../docs/site/files/040_systeemschema"
...
<!-- Vanaf hieronder tekst schrijven (de bookdownhandleiding overschrijven dus ;-) ) -->
