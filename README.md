...
- 110 (in Dutch:) design of the monitoring subprogramme for the groundwater compartment
- (to be extended)
...
The MNE aims at drawing conclusions on both state and trend of environmental characteristics of (groups of) habitat types at a regional level.
They allow to prioritize, underpin and evaluate environment-oriented nature policy measures at the Flemish scale by generating representative long-term data of known quality.
Hence, their primary function is to provide quantitative diagnostics of relevant environmental issues.
...
To this end, each environmental compartment (groundwater, surface water, atmosphere and soil) will be served by a specific MNE monitoring _sub_programme aligned with the six-year cycles of the Natura 2000 policy.

The MNE will provide solid conclusions for (groups of) habitat types at the Flemish scale, but will be based on a selection of sites in space and time.
